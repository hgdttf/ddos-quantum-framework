#!/usr/bin/env python3
"""
Classical Neural Network (MLP) for DDoS Detection — WITH SCORE SAVING FOR ROC CURVES
...
SCORES_DIR = '/root/ddos-framework/results/scores/classical_nn'
...
def evaluate_dataset(name, path, k):
    """Run k-fold CV and return average metrics with score saving."""
    X, y = load_data(path)
    ...
    for fold, (train_idx, test_idx) in enumerate(skf.split(X, y), 1):
        ...
        y_proba = clf.predict_proba(X_test)[:, 1]  # Probability of class 1 (attack)
