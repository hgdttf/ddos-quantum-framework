...
ORIGINAL PAPER CONFIG: MinMaxScaler [0,1] only — NO QuantileTransformer
This matches the exact configuration used to generate paper results
Ver: 3.2 | Date: 2026-07-10
"""
...
def run_kfold(dataset_name, k):
    ...
    # ORIGINAL PAPER CONFIG: Only MinMaxScaler [0, 1] — NO QuantileTransformer
